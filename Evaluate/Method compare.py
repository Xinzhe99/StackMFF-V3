...
def parse_args():
    ...
    parser.add_argument('--methods', type=str, nargs='+', default=['MCCSR-Net'],
                        help='List of methods to compare')
    parser.add_argument('--datasets', type=str, nargs='+', 
                        default=['FlyingThings3D','Middlebury','Mobile Depth','Road-MF','NYU Depth V2'],
...
def main():
    ...
    for dataset in args.datasets:
        ...
        # Save results to Excel file, filename includes method name and dataset name
        output_filename = f'compare_result_{method}_{dataset}.xlsx'
    ...
    # After all datasets are processed, print summary results
    print("\n" + "=" * 60)
