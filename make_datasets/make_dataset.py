...
def process_single_image(args):
    ...
    try:
        ...
        order_info = np.array([
            list(range(num_regions)),  # original_order
            layer_order,               # shuffled_order
            num_regions                # num_layers
        ], dtype=object)
...
if __name__ == "__main__":
    ...
    process_images(args.original_path, args.depth_path, args.output_path, max_workers=args.max_workers)